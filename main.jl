...
MAX_NUMBER_OF_ATTEMPTS = 500000#100000#50000;
...
function main(degree,certification)    
    ...
    Random.seed!(0)
    best_traj,tmax,λ, lb, logs = dual_solving(sys,degree,x0,xT,traj_heur,tmax,ϵ,μ,simplex,certification)
    ...
    save("logs/"*name*"_"*string(degree)*"_"*string(certification)*"withScip.jld", "data", logs)
